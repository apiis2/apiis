  ...
  <Block Description="Master block" Name="Masterblock">
    <DataSource Name="DataSource_0">
      ...
      <Column DBName="db_animal" Name="Column_0" Order="0" Type="DB">
          <IdSet Name="idset_Column_0a" SetName="HB"/>
      </Column>
    ...
    <DataSource Name="DataSource_Field_5">
      <Sql Statement="select ext_code, long_name from codes where class='GESCHLECHT' order by long_name"/>
    </DataSource>
      <BrowseEntry Size="5"/>
    ...
    <DataSource Name="DataSource_Field_51">
      <Sql Statement="select ext_code, long_name from codes where class='RASSE' order by long_name"/>
    </DataSource>
      <BrowseEntry Size="5"/>
  ...
  <Block Description="Detail block" Name="Detailblock">
    ...
    <DataSource Name="DataSource_1">
      ...
      <Column DBName="db_dam" Name="Column_6" Order="6" Type="DB">
          <IdSet Name="idset_Column_6a" SetName="HB"/>
      </Column>
      <Column DBName="db_animal" Name="Column_7" Order="7" Type="DB">
          <IdSet Name="idset_Column_7a" SetName="HB"/>
          <IdSet Name="idset_Column_7b" SetName="LBN"/>
          <IdSet Name="idset_Column_7c" SetName="LMN"/>
      </Column>
